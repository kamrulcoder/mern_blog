            ...
            <div className="col-8">
              <Switch>
                ...
                <Route
                  ...
                  component={CategoryArtical}
                  exact
                />
                <Route
                  path="/artical/tag/:tagSlug/:currentPage?"
                  component={TagArtical}
                  exact
                />
                <Route
            ...
            <div className="col-4">
              <div className="search-category-tag">
                ...
                <div className="flow-facebook">
                  ...
                  <div className="image">
                    <iframe
                      src="https://www.facebook.com/plugins/page.php?href=https%3A%2F%2Fwww.facebook.com%2FIslam-100798538341988&tabs=timeline&width=340&height=148&small_header=false&adapt_container_width=true&hide_cover=false&show_facepile=true&appId"
                      style={{
                        width: "340px",
                        height: "145px",
                        border: "none",
                ...
                <div className="category">
                  ...
                  <ul className="cate-list">
                    <div className="cate-item">
                      <li>
                        <FaChevronRight />
                        <Link to={`/artical/category/}`}>Programming </Link>
                      </li>
                      <span>(10)</span>
                    </div>
                    <div className="cate-item">
                ...
                <div className="tag">
                  ...
                  <ul>
                    <li>
                      <Link to={`/artical/tag/`}>Programming </Link>
                    </li>
                    <li>
                      <Link to={`/artical/tag/`}>Marketing </Link>
                    </li>
                    <li>
                      <Link to={`/artical/tag/`}>Search Engine </Link>
                    </li>
                    <li>
                      <Link to={`/artical/tag/`}>Graphics Design </Link>
                    </li>
                  </ul>
                </div>
              </div>
